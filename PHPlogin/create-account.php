...
<div class="container">
  ...
  $genero = $_POST['rbgenero'];
	...
	$query = "INSERT INTO users (Name,Lastname,Document,Genero,Telefono, Email, Password)
  VALUES ('$name','$lastname','$document','$genero','$telefono', '$email', '$passHash')";
