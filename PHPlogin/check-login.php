...
<html lang="en">
	...
	<body>
		...
		<header>
			<input type="checkbox" id="btnMenu" name="" value="">
			<label for="btnMenu">Menú <img  class="menu2"src="images/Menu1.png" alt="Menú de Navegación">
				</label>
				<nav class="menu">
		<ul>
			<li class="ed"><a href="">CLIÍNICA TÚ MEJOR SONRISA</a></li>
			<li><a href="">TRATAMIENTOS</a></li>
			<li><a href="">REALIZAR CITAS</a></li>
			<li><a href="HistorialCita.">MI LIBRO DE CITAS</a></li>
			<li><a href="">DOCTORES</a></li>
			<li><a href="">ESPECIALIDADES</a></li>

<ul>
	<li><a href="">MI PERFÍL</a></li>
	<li><a href="http://localhost/nuevo/PHPlogin/login.html">Cerrar sesión</a></li>
